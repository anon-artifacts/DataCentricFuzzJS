...
function f3(a4) {
    print(a4.theFunction());
}
var callFunctionOnObject = f3;
function f8(a9) {
    this.p0 = 0;
    this.p1 = 1;
    this.p2 = 2;
...
function testLargeObjectConstructorWithFinalType() {
    ...
    const v273 = new LargeObject(f271);
    var largeObject1 = v273;
    callFunctionOnObject(largeObject1);
    callFunctionOnObject(largeObject1);
    function f277() {
        return "function on the second object";
    }
    const v279 = new LargeObject(f277);
    var largeObject2 = v279;
    callFunctionOnObject(largeObject1);
