...
explore("v35", f8, this, [F2, -4.0, Uint8Array, F2, f8], 29764);
f8();
// CRASH INFO
// ==========
// TERMSIG: 6
...
// #
// #
// #FailureMessage Object: 0x7efc8bb78700
// ==== C stack trace ===============================
// 
//     v8/out/fuzzbuild/d8(+0xbd9a82) [0x560949306a82]
//     v8/out/fuzzbuild/d8(+0xbd82a7) [0x5609493052a7]
//     v8/out/fuzzbuild/d8(+0xbcc546) [0x5609492f9546]
//     v8/out/fuzzbuild/d8(+0xbcbd95) [0x5609492f8d95]
//     v8/out/fuzzbuild/d8(+0x26e513e) [0x56094ae1213e]
//     v8/out/fuzzbuild/d8(+0x2ab07a6) [0x56094b1dd7a6]
//     v8/out/fuzzbuild/d8(+0x26423eb) [0x56094ad6f3eb]
//     v8/out/fuzzbuild/d8(+0x25f0150) [0x56094ad1d150]
//     v8/out/fuzzbuild/d8(+0x25ecfd8) [0x56094ad19fd8]
//     v8/out/fuzzbuild/d8(+0x23435d8) [0x56094aa705d8]
//     v8/out/fuzzbuild/d8(+0x233a7e9) [0x56094aa677e9]
//     v8/out/fuzzbuild/d8(+0xdb8cb2) [0x5609494e5cb2]
//     v8/out/fuzzbuild/d8(+0x233d588) [0x56094aa6a588]
//     v8/out/fuzzbuild/d8(+0xbdd14f) [0x56094930a14f]
//     v8/out/fuzzbuild/d8(+0xbe8925) [0x560949315925]
//     v8/out/fuzzbuild/d8(+0xbd5650) [0x560949302650]
//     /lib/x86_64-linux-gnu/libc.so.6(+0x94ac3) [0x7efc99738ac3]
//     /lib/x86_64-linux-gnu/libc.so.6(+0x126850) [0x7efc997ca850]
// Received signal 6
// STDOUT:
// EXPLORE_ACTION: {"operation":"CALL_METHOD","inputs":[{"special":{"name":"exploredValue"}},{"string":{"value":"unshift"}},{"argument":{"index":3}}],"isGuarded":true,"id":"v5"}
// EXPLORE_ACTION: {"operation":"CALL_METHOD","inputs":[{"special":{"name":"exploredValue"}},{"string":{"value":"propertyIsEnumerable"}},{"argument":{"index":1}}],"isGuarded":true,"id":"v10"}
// EXPLORE_ACTION: {"operation":"DEC","inputs":[{"special":{"name":"exploredValue"}}],"isGuarded":false,"id":"v11"}
// EXPLORE_ACTION: {"operation":"DIV","inputs":[{"special":{"name":"exploredValue"}},{"int":{"value":268435439}}],"isGuarded":false,"id":"v19"}
// EXPLORE_ACTION: {"operation":"CONSTRUCT","inputs":[{"special":{"name":"exploredValue"}},{"argument":{"index":3}}],"isGuarded":true,"id":"v35"}
// EXPLORE_ACTION: {"operation":"SIGNED_RIGHT_SHIFT","inputs":[{"special":{"name":"exploredValue"}},{"int":{"value":2}}],"isGuarded":false,"id":"v64"}
// EXPLORE_ACTION: {"operation":"SET_PROPERTY","inputs":[{"special":{"name":"exploredValue"}},{"string":{"value":"b"}},{"argument":{"index":0}}],"isGuarded":false,"id":"v36"}
// EXPLORE_ACTION: {"operation":"GET_PROPERTY","inputs":[{"special":{"name":"exploredValue"}},{"string":{"value":"name"}}],"isGuarded":false,"id":"v37"}
// EXPLORE_ACTION: {"operation":"SET_PROPERTY","inputs":[{"special":{"name":"exploredValue"}},{"string":{"value":"d"}},{"argument":{"index":1}}],"isGuarded":false,"id":"v39"}
// EXPLORE_ACTION: {"operation":"BITWISE_AND","inputs":[{"special":{"name":"exploredValue"}},{"argument":{"index":0}}],"isGuarded":false,"id":"v41"}
// EXPLORE_ACTION: {"operation":"ADD","inputs":[{"special":{"name":"exploredValue"}},{"argument":{"index":2}}],"isGuarded":false,"id":"v47"}
// EXPLORE_ACTION: {"operation":"ADD","inputs":[{"special":{"name":"exploredValue"}},{"argument":{"index":0}}],"isGuarded":false,"id":"v44"}
// EXPLORE_ACTION: {"operation":"ADD","inputs":[{"special":{"name":"exploredValue"}},{"argument":{"index":0}}],"isGuarded":false,"id":"v45"}
// EXPLORE_ACTION: {"operation":"SET_PROPERTY","inputs":[{"special":{"name":"exploredValue"}},{"string":{"value":"name"}},{"argument":{"index":4}}],"isGuarded":false,"id":"v51"}
// EXPLORE_ACTION: {"operation":"SET_PROPERTY","inputs":[{"special":{"name":"exploredValue"}},{"int":{"value":5}},{"argument":{"index":0}}],"isGuarded":false,"id":"v26"}
// EXPLORE_ACTION: {"operation":"LOGICAL_OR","inputs":[{"special":{"name":"exploredValue"}},{"argument":{"index":2}}],"isGuarded":false,"id":"v30"}
// EXPLORE_ACTION: {"operation":"NULL_COALESCE","inputs":[{"special":{"name":"exploredValue"}},{"argument":{"index":1}}],"isGuarded":false,"id":"v32"}
// EXPLORE_ACTION: {"operation":"NULL_COALESCE","inputs":[{"special":{"name":"exploredValue"}},{"argument":{"index":3}}],"isGuarded":false,"id":"v55"}
// EXPLORE_ACTION: {"operation":"NULL_COALESCE","inputs":[{"special":{"name":"exploredValue"}},{"argument":{"index":3}}],"isGuarded":false,"id":"v53"}
// EXPLORE_ACTION: {"operation":"NULL_COALESCE","inputs":[{"special":{"name":"exploredValue"}},{"argument":{"index":2}}],"isGuarded":false,"id":"v70"}
// EXPLORE_FAILURE: v36
// 
// Scenario: Testing forin on object with prototype
// p0
// p1
// p2
// b
// a
// g
// Scenario: Testing forin on object with prototype after changing prototype
// p0
// p1
// p2
// b
