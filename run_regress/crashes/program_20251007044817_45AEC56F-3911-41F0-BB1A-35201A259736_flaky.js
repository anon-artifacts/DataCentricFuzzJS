...
const v2 = [34253,9223372036854775807,-1,961722841,-4294967297,9007199254740991,-50200,5];
function f3(a4) {
    printprops(a4);
}
function printprops(a8, a9) {
    for (const v11 in a8) {
        explore("v34", a9, this, [false, a9, 4, v2, 3], 805494846);
    }
}
f3();
f3(this);
explore("v186", this, this, ["let y", printprops, "const w", this, print], 4294901760);
// CRASH INFO
// ==========
// TERMSIG: 6
// STDERR:
// [COV] edge counters initialized. Shared memory: shm_id_1162266_17 with 1587369 edges
...
// #
// #
// #FailureMessage Object: 0x7fc44382b700
// ==== C stack trace ===============================
// 
//     v8/out/fuzzbuild/d8(+0xbd9a82) [0x5654ca286a82]
//     v8/out/fuzzbuild/d8(+0xbd82a7) [0x5654ca2852a7]
//     v8/out/fuzzbuild/d8(+0xbcc546) [0x5654ca279546]
//     v8/out/fuzzbuild/d8(+0xbcbd95) [0x5654ca278d95]
//     v8/out/fuzzbuild/d8(+0x26e513e) [0x5654cbd9213e]
//     v8/out/fuzzbuild/d8(+0x2ab07a6) [0x5654cc15d7a6]
//     v8/out/fuzzbuild/d8(+0x26423eb) [0x5654cbcef3eb]
//     v8/out/fuzzbuild/d8(+0x25f0150) [0x5654cbc9d150]
//     v8/out/fuzzbuild/d8(+0x25ecfd8) [0x5654cbc99fd8]
//     v8/out/fuzzbuild/d8(+0x23435d8) [0x5654cb9f05d8]
//     v8/out/fuzzbuild/d8(+0x233a7e9) [0x5654cb9e77e9]
//     v8/out/fuzzbuild/d8(+0xdb8cb2) [0x5654ca465cb2]
//     v8/out/fuzzbuild/d8(+0x233d588) [0x5654cb9ea588]
//     v8/out/fuzzbuild/d8(+0xbdd14f) [0x5654ca28a14f]
//     v8/out/fuzzbuild/d8(+0xbe8925) [0x5654ca295925]
//     v8/out/fuzzbuild/d8(+0xbd5650) [0x5654ca282650]
//     /lib/x86_64-linux-gnu/libc.so.6(+0x94ac3) [0x7fc4513ebac3]
//     /lib/x86_64-linux-gnu/libc.so.6(+0x126850) [0x7fc45147d850]
// Received signal 6
// STDOUT:
// EXPLORE_ACTION: {"operation":"GET_PROPERTY","inputs":[{"special":{"name":"exploredValue"}},{"int":{"value":0}}],"isGuarded":false,"id":"v6"}
// EXPLORE_ACTION: {"operation":"CALL_METHOD","inputs":[{"special":{"name":"exploredValue"}},{"string":{"value":"every"}},{"argument":{"index":4}}],"isGuarded":true,"id":"v7"}
// EXPLORE_ACTION: {"operation":"GET_PROPERTY","inputs":[{"special":{"name":"exploredValue"}},{"string":{"value":"caller"}}],"isGuarded":false,"id":"v22"}
// EXPLORE_ACTION: {"operation":"CALL_METHOD","inputs":[{"special":{"name":"exploredValue"}},{"string":{"value":"call"}},{"argument":{"index":4}}],"isGuarded":true,"id":"v26"}
// EXPLORE_ACTION: {"operation":"NULL_COALESCE","inputs":[{"special":{"name":"exploredValue"}},{"argument":{"index":3}}],"isGuarded":false,"id":"v52"}
// EXPLORE_ACTION: {"operation":"NULL_COALESCE","inputs":[{"special":{"name":"exploredValue"}},{"argument":{"index":1}}],"isGuarded":false,"id":"v54"}
// EXPLORE_ACTION: {"operation":"SET_PROPERTY","inputs":[{"special":{"name":"exploredValue"}},{"string":{"value":"e"}},{"argument":{"index":3}}],"isGuarded":false,"id":"v65"}
// EXPLORE_ACTION: {"operation":"NULL_COALESCE","inputs":[{"special":{"name":"exploredValue"}},{"argument":{"index":4}}],"isGuarded":false,"id":"v66"}
// EXPLORE_ACTION: {"operation":"SET_PROPERTY","inputs":[{"special":{"name":"exploredValue"}},{"string":{"value":"b"}},{"argument":{"index":4}}],"isGuarded":false,"id":"v69"}
// EXPLORE_ACTION: {"operation":"NULL_COALESCE","inputs":[{"special":{"name":"exploredValue"}},{"argument":{"index":0}}],"isGuarded":false,"id":"v70"}
// EXPLORE_ACTION: {"operation":"CONSTRUCT_METHOD","inputs":[{"special":{"name":"exploredValue"}},{"string":{"value":"TypeError"}},{"argument":{"index":2}}],"isGuarded":true,"id":"v74"}
// EXPLORE_ACTION: {"operation":"NULL_COALESCE","inputs":[{"special":{"name":"exploredValue"}},{"argument":{"index":0}}],"isGuarded":false,"id":"v78"}
// EXPLORE_ACTION: {"operation":"NULL_COALESCE","inputs":[{"special":{"name":"exploredValue"}},{"argument":{"index":3}}],"isGuarded":false,"id":"v79"}
// EXPLORE_ACTION: {"operation":"CALL_METHOD","inputs":[{"special":{"name":"exploredValue"}},{"string":{"value":"printErr"}}],"isGuarded":true,"id":"v80"}
// EXPLORE_ACTION: {"operation":"NULL_COALESCE","inputs":[{"special":{"name":"exploredValue"}},{"argument":{"index":3}}],"isGuarded":false,"id":"v81"}
// EXPLORE_ACTION: {"operation":"CONSTRUCT_METHOD","inputs":[{"special":{"name":"exploredValue"}},{"string":{"value":"WeakMap"}}],"isGuarded":true,"id":"v23"}
...
// EXPLORE_ACTION: {"operation":"CONSTRUCT_METHOD","inputs":[{"special":{"name":"exploredValue"}},{"string":{"value":"Float64Array"}},{"argument":{"index":4}},{"argument":{"index":2}},{"argument":{"index":3}}],"isGuarded":true,"id":"v27"}
// EXPLORE_ACTION: {"operation":"SET_PROPERTY","inputs":[{"special":{"name":"exploredValue"}},{"string":{"value":"d"}},{"argument":{"index":2}}],"isGuarded":false,"id":"v28"}
// EXPLORE_ACTION: {"operation":"CALL_METHOD","inputs":[{"special":{"name":"exploredValue"}},{"string":{"value":"substring"}},{"argument":{"index":1}},{"argument":{"index":0}}],"isGuarded":true,"id":"v29"}
// EXPLORE_ACTION: {"operation":"SET_PROPERTY","inputs":[{"special":{"name":"exploredValue"}},{"int":{"value":0}},{"argument":{"index":4}}],"isGuarded":false,"id":"v30"}
// EXPLORE_ACTION: {"operation":"LOGICAL_NOT","inputs":[{"special":{"name":"exploredValue"}}],"isGuarded":false,"id":"v32"}
// EXPLORE_ACTION: {"operation":"CALL_METHOD","inputs":[{"special":{"name":"exploredValue"}},{"string":{"value":"strike"}}],"isGuarded":true,"id":"v33"}
// EXPLORE_ACTION: {"operation":"LOGICAL_OR","inputs":[{"special":{"name":"exploredValue"}},{"argument":{"index":2}}],"isGuarded":false,"id":"v34"}
// EXPLORE_ACTION: {"operation":"LOGICAL_OR","inputs":[{"special":{"name":"exploredValue"}},{"argument":{"index":2}}],"isGuarded":false,"id":"v21"}
// EXPLORE_ACTION: {"operation":"LOGICAL_AND","inputs":[{"special":{"name":"exploredValue"}},{"argument":{"index":2}}],"isGuarded":false,"id":"v36"}
// EXPLORE_ACTION: {"operation":"CONSTRUCT_METHOD","inputs":[{"special":{"name":"exploredValue"}},{"string":{"value":"trimLeft"}}],"isGuarded":true,"id":"v47"}
// EXPLORE_ACTION: {"operation":"GET_PROPERTY","inputs":[{"special":{"name":"exploredValue"}},{"string":{"value":"prototype"}}],"isGuarded":false,"id":"v48"}
// EXPLORE_ACTION: {"operation":"NULL_COALESCE","inputs":[{"special":{"name":"exploredValue"}},{"argument":{"index":3}}],"isGuarded":false,"id":"v25"}
// EXPLORE_ACTION: {"operation":"SET_PROPERTY","inputs":[{"special":{"name":"exploredValue"}},{"string":{"value":"f"}},{"argument":{"index":1}}],"isGuarded":false,"id":"v88"}
// EXPLORE_ACTION: {"operation":"CONSTRUCT_METHOD","inputs":[{"special":{"name":"exploredValue"}},{"string":{"value":"blink"}}],"isGuarded":true,"id":"v91"}
// EXPLORE_ACTION: {"operation":"NULL_COALESCE","inputs":[{"special":{"name":"exploredValue"}},{"argument":{"index":3}}],"isGuarded":false,"id":"v94"}
// EXPLORE_ACTION: {"operation":"SET_PROPERTY","inputs":[{"special":{"name":"exploredValue"}},{"string":{"value":"b"}},{"argument":{"index":0}}],"isGuarded":false,"id":"v100"}
// EXPLORE_ACTION: {"operation":"NULL_COALESCE","inputs":[{"special":{"name":"exploredValue"}},{"argument":{"index":1}}],"isGuarded":false,"id":"v102"}
// EXPLORE_ACTION: {"operation":"NULL_COALESCE","inputs":[{"special":{"name":"exploredValue"}},{"argument":{"index":3}}],"isGuarded":false,"id":"v108"}
// EXPLORE_ACTION: {"operation":"CONSTRUCT_METHOD","inputs":[{"special":{"name":"exploredValue"}},{"string":{"value":"TypeError"}},{"argument":{"index":0}}],"isGuarded":true,"id":"v112"}
// EXPLORE_ACTION: {"operation":"GET_PROPERTY","inputs":[{"special":{"name":"exploredValue"}},{"int":{"value":5}}],"isGuarded":false,"id":"v113"}
// EXPLORE_ACTION: {"operation":"NULL_COALESCE","inputs":[{"special":{"name":"exploredValue"}},{"argument":{"index":3}}],"isGuarded":false,"id":"v114"}
// EXPLORE_ACTION: {"operation":"CONSTRUCT_METHOD","inputs":[{"special":{"name":"exploredValue"}},{"string":{"value":"URIError"}},{"argument":{"index":2}}],"isGuarded":true,"id":"v118"}
// EXPLORE_ACTION: {"operation":"CALL_METHOD","inputs":[{"special":{"name":"exploredValue"}},{"string":{"value":"strike"}}],"isGuarded":true,"id":"v40"}
// EXPLORE_ACTION: {"operation":"NULL_COALESCE","inputs":[{"special":{"name":"exploredValue"}},{"argument":{"index":1}}],"isGuarded":false,"id":"v44"}
// EXPLORE_ACTION: {"operation":"CALL_METHOD","inputs":[{"special":{"name":"exploredValue"}},{"string":{"value":"isFinite"}},{"argument":{"index":0}}],"isGuarded":true,"id":"v124"}
// EXPLORE_ACTION: {"operation":"SET_PROPERTY","inputs":[{"special":{"name":"exploredValue"}},{"int":{"value":29}},{"argument":{"index":2}}],"isGuarded":false,"id":"v131"}
// EXPLORE_ACTION: {"operation":"NULL_COALESCE","inputs":[{"special":{"name":"exploredValue"}},{"argument":{"index":3}}],"isGuarded":false,"id":"v132"}
// EXPLORE_ACTION: {"operation":"NULL_COALESCE","inputs":[{"special":{"name":"exploredValue"}},{"argument":{"index":3}}],"isGuarded":false,"id":"v133"}
// EXPLORE_ACTION: {"operation":"NULL_COALESCE","inputs":[{"special":{"name":"exploredValue"}},{"argument":{"index":3}}],"isGuarded":false,"id":"v139"}
// EXPLORE_ACTION: {"operation":"NULL_COALESCE","inputs":[{"special":{"name":"exploredValue"}},{"argument":{"index":4}}],"isGuarded":false,"id":"v142"}
// EXPLORE_ACTION: {"operation":"CONSTRUCT_METHOD","inputs":[{"special":{"name":"exploredValue"}},{"string":{"value":"URIError"}},{"argument":{"index":3}}],"isGuarded":true,"id":"v148"}
// EXPLORE_ACTION: {"operation":"CALL_METHOD","inputs":[{"special":{"name":"exploredValue"}},{"string":{"value":"Map"}}],"isGuarded":true,"id":"v151"}
// EXPLORE_ACTION: {"operation":"SET_PROPERTY","inputs":[{"special":{"name":"exploredValue"}},{"int":{"value":1}},{"argument":{"index":1}}],"isGuarded":false,"id":"v155"}
// EXPLORE_ACTION: {"operation":"NULL_COALESCE","inputs":[{"special":{"name":"exploredValue"}},{"argument":{"index":3}}],"isGuarded":false,"id":"v156"}
// EXPLORE_ACTION: {"operation":"SET_PROPERTY","inputs":[{"special":{"name":"exploredValue"}},{"string":{"value":"d"}},{"argument":{"index":3}}],"isGuarded":false,"id":"v157"}
// EXPLORE_ACTION: {"operation":"NULL_COALESCE","inputs":[{"special":{"name":"exploredValue"}},{"argument":{"index":3}}],"isGuarded":false,"id":"v158"}
// EXPLORE_ACTION: {"operation":"SET_PROPERTY","inputs":[{"special":{"name":"exploredValue"}},{"int":{"value":4}},{"argument":{"index":1}}],"isGuarded":false,"id":"v159"}
// EXPLORE_ACTION: {"operation":"GET_PROPERTY","inputs":[{"special":{"name":"exploredValue"}},{"string":{"value":"Atomics"}}],"isGuarded":false,"id":"v161"}
// EXPLORE_ACTION: {"operation":"CALL_METHOD","inputs":[{"special":{"name":"exploredValue"}},{"string":{"value":"localeCompare"}},{"argument":{"index":2}}],"isGuarded":true,"id":"v162"}
// 
