...
function expectNoProperty(a14, a15) {
    var desc = Object.getOwnPropertyDescriptor(a14, a15);
    (("should be no '" + a15) + "' property on ") + a14;
}
