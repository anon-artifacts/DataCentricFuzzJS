var test = 1;
function fail(a3, a4, a5) {
    print((((("failure in test " + test) + "; expected ") + a4) + ", got ") + a5);
}
function test0() {
    var x;
    var y;
...
function test14() {
    ...
    ++test;
    result = 1073741822 * (-1073741823 - 1);
    check = -1152921502459363328;
    if (result != check) {
        {
            fail(test, check, result);
...
function test15() {
    ...
    ++test;
    result = 1073741823 * (-1073741823 - 1);
    check = -1152921503533105152;
    if (result != check) {
        {
            fail(test, check, result);
...
function test16() {
    ...
    ++test;
    result = 1073741824 * (-1073741823 - 1);
    check = -1152921504606846976;
    if (result != check) {
        {
            fail(test, check, result);
...
function test18() {
    ...
    ++test;
    result = 1073741825 * (-1073741823 - 1);
    check = -1152921505680588800;
    if (result != check) {
        {
            fail(test, check, result);
...
function test20() {
    ...
    ++test;
    result = (-1073741823 - 1) * 1073741822;
    check = -1152921502459363328;
    if (result != check) {
        {
            fail(test, check, result);
    ...
    ++test;
    result = (-1073741823 - 1) * 1073741823;
    check = -1152921503533105152;
    if (result != check) {
        {
            fail(test, check, result);
    ...
    ++test;
    result = (-1073741823 - 1) * 1073741824;
    check = -1152921504606846976;
    if (result != check) {
        {
            fail(test, check, result);
    ...
    ++test;
    result = (-1073741823 - 1) * 1073741825;
    check = -1152921505680588800;
    if (result != check) {
        {
            fail(test, check, result);
    ...
    ++test;
    result = (-1073741823 - 1) * (-1073741823 - 1);
    check = 1152921504606846976;
    if (result != check) {
        {
            fail(test, check, result);
    ...
    ++test;
    result = (-1073741823 - 1) * -1073741826;
    check = 1152921506754330624;
    if (result != check) {
        {
            fail(test, check, result);
    ...
    ++test;
    result = (-1073741823 - 1) * 2147483646;
    check = -2305843007066210304;
    if (result != check) {
        {
            fail(test, check, result);
    ...
    ++test;
    result = (-1073741823 - 1) * 2147483647;
    check = -2305843008139952128;
    if (result != check) {
        {
            fail(test, check, result);
    ...
    ++test;
    result = (-1073741823 - 1) * 2147483648;
    check = -2305843009213693952;
    if (result != check) {
        {
            fail(test, check, result);
    ...
    ++test;
    result = (-1073741823 - 1) * 2147483649;
    check = -2305843010287435776;
    if (result != check) {
        {
            fail(test, check, result);
    ...
    ++test;
    result = (-1073741823 - 1) * -2147483650;
    check = 2305843011361177600;
    if (result != check) {
        {
            fail(test, check, result);
    ...
    ++test;
    result = (-1073741823 - 1) * 4294967295;
    check = -4611686017353646080;
    if (result != check) {
        {
            fail(test, check, result);
    ...
    ++test;
    result = (-1073741823 - 1) * 4294967296;
    check = -4611686018427387904;
    if (result != check) {
        {
            fail(test, check, result);
...
function test22() {
    ...
    ++test;
    result = -1073741826 * (-1073741823 - 1);
    check = 1152921506754330624;
    if (result != check) {
        {
            fail(test, check, result);
...
function test24() {
    ...
    ++test;
    result = 2147483646 * (-1073741823 - 1);
    check = -2305843007066210304;
    if (result != check) {
        {
            fail(test, check, result);
...
function test25() {
    ...
    ++test;
    result = 2147483647 * (-1073741823 - 1);
    check = -2305843008139952128;
    if (result != check) {
        {
            fail(test, check, result);
...
function test26() {
    ...
    ++test;
    result = 2147483648 * (-1073741823 - 1);
    check = -2305843009213693952;
    if (result != check) {
        {
            fail(test, check, result);
...
function test27() {
    ...
    ++test;
    result = 2147483649 * (-1073741823 - 1);
    check = -2305843010287435776;
    if (result != check) {
        {
            fail(test, check, result);
...
function test32() {
    ...
    ++test;
    result = -2147483650 * (-1073741823 - 1);
    check = 2305843011361177600;
    if (result != check) {
        {
            fail(test, check, result);
...
function test33() {
    ...
    ++test;
    result = 4294967295 * (-1073741823 - 1);
    check = -4611686017353646080;
    if (result != check) {
        {
            fail(test, check, result);
...
function test34() {
    ...
    ++test;
    result = 4294967296 * (-1073741823 - 1);
    check = -4611686018427387904;
    if (result != check) {
        {
            fail(test, check, result);
