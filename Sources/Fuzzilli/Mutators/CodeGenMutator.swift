...
public class CodeGenMutator: BaseInstructionMutator {
    ...
    public override func canMutate(_ instr: Instruction) -> Bool {
        ...
        return variableAnalyzer.visibleVariables.count >= defaultMinVisibleVariables && !deadCodeAnalyzer.currentlyInDeadCode
    }

    public override func mutate(_ instr: Instruction, _ b: ProgramBuilder) {
        b.adopt(instr)
        assert(b.numberOfVisibleVariables >= defaultMinVisibleVariables)
